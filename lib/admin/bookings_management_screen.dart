  ...
  void _applyFilters() {
    ...
    setState(() {
      _filteredBookings = allBookings.where((booking) {
        ...
        if (_filterLocation != 'All Locations' && booking.location != _filterLocation) {
          return false;
        }
                      ...
                      rows: _filteredBookings.map((booking) {
                        ...
                        return DataRow(
                          cells: [
                            ...
                            DataCell(Text(DateFormat('MMM d, y HH:mm').format(booking.dateTime))),
                            DataCell(Text(booking.userId)),
                            DataCell(
                              Container(
                                padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                                decoration: BoxDecoration(
                                  color: isUpcoming ? Colors.green.shade100 : Colors.grey.shade300,
                                  borderRadius: BorderRadius.circular(12),
                                ),
                                child: Text(
                                  isUpcoming ? 'Upcoming' : 'Past',
                                  style: TextStyle(
                                    color: isUpcoming ? Colors.green.shade800 : Colors.grey.shade800,
                                  ),
                                ),
                              ),
                            ),
